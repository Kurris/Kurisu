...
namespace Kurisu.Test.HelperClass
{
    public class TestLanguageHandler
    {
        ...
        {
            var model = new TestModel { Title = "Ĭ��", Titleen = "EN", Description = "desc", Descriptionfr = "fr" };
            ...
            Assert.Equal("Ĭ��", token["title"]?.Value<string>());
        ...
        public void HandleResult_ListOfObjects_TransformsEachItem()
        {
            ...
            {
                new TestModel { Title = "Ĭ��1", Titleen = "EN1" },
                new TestModel { Title = "Ĭ��2", Titleen = "EN2" }
            };
        ...
        public void HandleResult_Dictionary_ReturnsOriginal()
        {
            ...
            {
                ["a"] = new TestModel { Title = "Ĭ��1", Titleen = "EN1" },
                ["b"] = new TestModel { Title = "Ĭ��2", Titleen = "EN2" }
            };
        ...
        public void HandleResult_NonGenericDictionary_TransformsValues()
        {
            ...
            ht["a"] = new TestModel { Title = "Ĭ��", Titleen = "EN" };
            ht[1] = new TestModel { Title = "Ĭ��2", Titleen = "EN2" };
        ...
        {
            var parent = new ParentModel { Name = "p", Child = new TestModel { Title = "Ĭ��", Titleen = "EN" } };
