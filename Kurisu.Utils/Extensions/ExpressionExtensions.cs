...
public static class ExpressionExtensions
{
    ...
    public static void SetPropertyValue<T>(this T obj, Expression<Func<T, object>> predicate, object value) => SetPropertyValue(obj, (predicate.Body as MemberExpression).Member.Name, value);
