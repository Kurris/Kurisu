...
internal static class TypeInfoUtils
{
    ...
    private static bool HasReferenceConversion(TypeInfo source, TypeInfo dest)
    {
        ...
        var nnSourceType = GetNonNullableType(source).GetTypeInfo();
        var nnDestType = GetNonNullableType(dest).GetTypeInfo();
