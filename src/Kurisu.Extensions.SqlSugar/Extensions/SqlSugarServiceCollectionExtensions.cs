...
public static class SqlSugarServiceCollectionExtensions
{
    ...
    public static void AddSqlSugar(this IServiceCollection services, DbType dbType, Action<IServiceProvider, ISqlSugarClient> configDb = null)
    {
        ...
        services.AddSingleton<DefaultSqlSugarConfigHandler>();

        services.AddSingleton(typeof(ConfigureExternalServices), _ =>
        {
        ...
        services.AddTransient(typeof(ISqlSugarClient), provider =>
        {
            ...
            var connectionHandler = provider.GetRequiredService<IDbConnectionManager>();
...
public class DefaultSqlSugarConfigHandler
{
        ...
        IStateSnapshotManager<DbOperationState> snapshotManager)
    {
        ...
        Logger = logger;
        _sqlSugarOptions = options.Value;
    }
    ...
    {
        var opState = _snapshotManager.Current;
