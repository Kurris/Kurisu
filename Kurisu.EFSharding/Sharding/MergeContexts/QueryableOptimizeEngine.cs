...
internal sealed class QueryableOptimizeEngine : IQueryableOptimizeEngine
{
        ...
        IRewriteResult rewriteResult)
    {
        ...
        var sameWithTailComparer = true;
        var sequenceQuery = false;
        ...
        return new OptimizeResult(maxParallelExecuteCount, sequenceQuery, sameWithTailComparer,
