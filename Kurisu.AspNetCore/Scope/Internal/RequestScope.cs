...
internal class RequestScope : IScope
{
    ...
    {
        await handler.Invoke(App.GetServiceProvider());
    }
    ...
    {
        handler.Invoke(App.GetServiceProvider());
    }
    ...
    {
        return handler.Invoke(App.GetServiceProvider());
    }
    ...
    {
        return await handler.Invoke(App.GetServiceProvider());
    }
}