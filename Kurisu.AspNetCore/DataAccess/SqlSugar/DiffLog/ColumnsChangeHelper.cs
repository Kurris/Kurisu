...
using Kurisu.AspNetCore.DataAccess.SqlSugar.DiffLog.Contants;
using Kurisu.AspNetCore.DataAccess.SqlSugar.DiffLog.Models;
                ...
                foreach (var column in item.Columns)
                {
                    ...
                    if (c.Value != column.Value)
                    {
                        changeInfos.Add(new ColumnChangesDetail
                        {
                            ...
                            Detail = c.Value + CombineConstants.Arrow + column.Value
                        });
                    }
                }
            }
