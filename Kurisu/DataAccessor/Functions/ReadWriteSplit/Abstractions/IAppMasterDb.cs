...
public interface IAppMasterDb : IAppSlaveDb
{
    ...
    /// <remarks>参数化:insert into blog values({0},{1}) </remarks>
    ...
    /// <returns>返回受影响行<see cref="int"/></returns>
    /// <remarks>参数化:$"insert into blog values({value1},{value2})" </remarks>
    ...
    /// <returns>返回受影响行<see cref="int"/></returns>
    Task DeleteByIdsAsync<T>(params object[] keyValues) where T : class, new();
