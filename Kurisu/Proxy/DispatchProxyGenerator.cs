...
namespace Kurisu.Proxy
{
    ...
    internal static class DispatchProxyGenerator
    {
        ...
        private static readonly MethodInfo s_dispatchProxyInvokeAsyncMethod = typeof(DispatchProxy).GetTypeInfo().GetDeclaredMethod("InvokeAsync");

        private static readonly MethodInfo s_dispatchProxyInvokeAsyncTMethod = typeof(DispatchProxy).GetTypeInfo().GetDeclaredMethod("InvokeAsyncT");
        ...
        public static object Invoke(object[] args)
        {
            ...
            catch (TargetInvocationException tie)
            {
                ...
                ExceptionDispatchInfo.Capture((tie.InnerException?.InnerException ?? tie.InnerException) ??
        ...
        private class PackedArgs
        {
            ...
            internal DispatchProxy DispatchProxy => (DispatchProxy)_args[DispatchProxyPosition];
        ...
        private class ProxyAssembly
        {
            ...
            internal void EnsureTypeIsVisible(Type type)
            {
                ...
                {
                    var assemblyName = Assembly.GetAssembly(typeInfo)?.GetName().Name;
    ...
    /// <summary>
    /// 代理分发处理,方法必须为public，否则外部无法调用具体的方法
    /// </summary>
    public class DispatchProxyHandler
    {
        ...
        {
            return DispatchProxyGenerator.Invoke(args);
        }
        ...
        {
            return DispatchProxyGenerator.InvokeAsync(args);
        }
        ...
        {
            return DispatchProxyGenerator.InvokeAsync<T>(args);
        }
    }
}